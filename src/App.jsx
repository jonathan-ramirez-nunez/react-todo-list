...
export default function App() {
  ...
  // run this function inside useEffect everytime the objects inside the
  // array of our second property change. we use this useEffect to store
  // our information in local storage
  useEffect(() => {
